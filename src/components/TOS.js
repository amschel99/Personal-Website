      ...
      <Container>
        <Row>
          <Col>
            ...
            <p>We will not be liable for any damages arising out of or in connection with your use of our website, including but not limited to direct, indirect, incidental, special, or consequential damages.</p>
            <p>These Terms shall be governed by and construed in accordance with the laws of Kenya. Any disputes arising out of or in connection with these Terms shall be submitted to the exclusive jurisdiction of the courts of Kenya.</p>
          </Col>
        </Row>
        <Row>
          <Col>
            <h1 style={{ textAlign: 'center', margin: '2rem 0' }}>Privacy Policy</h1>
            <p>We respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, and disclose your personal data when you use our website.</p>
            <p>We may collect personal data from you when you sign up for our newsletter, purchase an ebook, or interact with our website in other ways. This may include your name, email address, billing address, and payment information.</p>
            <p>We may use your personal data to provide you with our products and services, communicate with you, and improve our website. We may also use your personal data to send you marketing communications if you have consented to receive them.</p>
            <p>We may disclose your personal data to third-party service providers who assist us with our operations, such as payment processors and email service providers. We may also disclose your personal data if required by law or to protect our rights or the rights of others.</p>
            <p>We take reasonable steps to protect your personal data from unauthorized access, disclosure, or alteration. However, no method of transmission over the internet or method of electronic storage is 100% secure, so
            we cannot guarantee the absolute security of your personal data.</p>
